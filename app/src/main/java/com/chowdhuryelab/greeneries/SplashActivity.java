...
public class SplashActivity extends AppCompatActivity {
    ...
    ImageView iconeIV;
    TextView iconText;
    Animation leftAnimation, bottomAnimation,bottomMiddleAnimation, topAnimation;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomMiddleAnimation = AnimationUtils.loadAnimation(this, R.anim.bottom_animation);

        iconeIV.setAnimation(bottomMiddleAnimation);
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                if (user == null){
                    ...
                    Intent intent = new Intent(SplashActivity.this, MainBuyerActivity.class);
