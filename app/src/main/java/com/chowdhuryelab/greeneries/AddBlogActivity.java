...
public class AddBlogActivity extends AppCompatActivity {
    ...
    private String blogTitle, blogDescription, productCategory;
...
//        publiclyAvailable = findViewById(R.id.publiclyAvailableSwitch);
...
//        publiclyAvailableSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
//            @Override
...
//        });
    ...
    private void inputData() {
        blogTitle = titleEt.getText().toString().trim();
        blogDescription = descriptionEt.getText().toString().trim();
    ...
    private void addBlog() {
        mProgressDialog.setMessage("Posting Blog...");
        mProgressDialog.show();

        final String timestamp = ""+System.currentTimeMillis();
        if (image_uri == null){
            HashMap<String, Object> hashMap = new HashMap<>();
            hashMap.put("blogId", ""+timestamp);
            ...
            ref.child(mAuth.getUid()).child("Blogs").child(timestamp).setValue(hashMap)
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
                        public void onSuccess(Void aVoid) {
                            mProgressDialog.dismiss();
                            Toast.makeText(AddBlogActivity.this, "Blog Posted...", Toast.LENGTH_SHORT).show();
                            clearData();
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            mProgressDialog.dismiss();
                            Toast.makeText(AddBlogActivity.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });

        }
        else {
            String fileAndPath ="blogs_image/"+ ""+ timestamp;
                    ...
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            if (uriTask.isSuccessful()){
                                ...
                                hashMap.put("blogDescription", ""+blogDescription);
                                hashMap.put("prductCategory", ""+productCategory);
                                hashMap.put("blogImg", ""+downlodeImageUri);
                                hashMap.put("timestamp", ""+timestamp);
                                hashMap.put("uid", ""+mAuth.getUid());
    ...
    private void clearData() {
        ...
        categoryTv.setText("");
        blogIv.setImageResource(R.drawable.ic_add_procuct_primary);
        image_uri = null;
    }
