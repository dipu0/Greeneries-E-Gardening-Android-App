...
import com.chowdhuryelab.greeneries.FilterProduct;
import com.chowdhuryelab.greeneries.R;
import com.chowdhuryelab.greeneries.EditProductActivity;
...
public class AdapterProductSeller extends RecyclerView.Adapter<AdapterProductSeller.HolderProductSeller> implements Filterable {
    ...
    public void onBindViewHolder(@NonNull HolderProductSeller holder, int position) {
        ...
        try {
            Picasso.get().load(productIcon).placeholder(R.drawable.ic_cart_type2).into(holder.productIv);
        }
        catch (Exception e) {
            holder.productIv.setImageResource(R.drawable.ic_cart_type2);
        }
