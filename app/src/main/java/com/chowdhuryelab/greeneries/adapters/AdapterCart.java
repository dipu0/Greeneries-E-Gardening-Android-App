...
import com.chowdhuryelab.greeneries.models.ModelCart;
...
public class AdapterCart extends RecyclerView.Adapter<AdapterCart.HolderCart> {
    ...
    public void onBindViewHolder(@NonNull HolderCart holder, int position) {
        ...
        try {
            Picasso.get().load(itemImage).placeholder(R.drawable.ic_cart_type2).into(holder.productIconIv);
        }
        catch (Exception e){
            holder.productIconIv.setImageResource(R.drawable.ic_cart_type2);
        }
