...
public class AdapterAllProductShow extends RecyclerView.Adapter<AdapterAllProductShow.HolderAdapterProductShow> implements Filterable{
    ...
    public AdapterAllProductShow(Context context, ArrayList<ModelProduct> productList) {
    ...
    @NonNull
    @Override
    public HolderAdapterProductShow onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public Filter getFilter() {
        if (filter==null) {
            filter = new FilterProductAll(this, filterList);
        }
        return filter;
    }
